    ...
    >
      <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
        ...
        <div className="mx-auto mb-12 relative">
          <div
            className="w-40 h-40 rounded-full mx-auto mb-6 shadow-lg border-4 border-white overflow-hidden transform hover:scale-105 transition-all duration-500"
          >
            <img
              src={profileImage}
              alt="Jobet Casquejo"
          ...
          <p className="text-lg text-gray-800 mb-6 fade-up-delay-100">
          ...
          <p className="text-lg text-gray-800 mb-6 fade-up-delay-200">
          ...
          <p className="text-lg text-gray-800 mb-6 fade-up-delay-300">
        ...
        <div className="absolute top-0 left-0 right-0 bottom-0 bg-gradient-to-r from-teal-300 to-blue-200 opacity-20 transform rotate-12 scale-150"></div>
      </div>
    </section>
  );
};
